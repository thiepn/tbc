...
![The Bible Challenge — animated hero](./assets/tbc-hero.svg)
...
<a href="https://thiepn.github.io/tbc">
  <img src="./assets/play-the-bible-challenge.svg" alt="Play The Bible Challenge now" width="100%">
</a>
...
- `npm run verify` is the complete canonical validation command used by CI; it includes `scripts/validate-release.cjs` and the preservation gates.
...
<sub>Works on desktop and mobile · The Bible Challenge v4.1.0</sub>
