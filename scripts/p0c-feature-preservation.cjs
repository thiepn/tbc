...
const checks = [
  ...
  ['campaign', 'Campaign remains represented with 72 missions', () => appHas(/Campaign/i) && readmeHas(/72\s+Campaign\s+missions/i)],
  ['expedition', 'Expedition remains represented with 12 arcs', () => appHas(/Expedition/i) && readmeHas(/12\s+Expedition\s+arcs/i)],
  ...
  ['export-import', 'progress export/import remains represented', () => appHas(/exportProgress/i) && /ImportProgress|importProgress/i.test(src.app)],
  ['session-restore', 'active quiz session save/restore remains represented', () => appHas(/saveQuizSession/i, /restoreQuizSession/i)],
