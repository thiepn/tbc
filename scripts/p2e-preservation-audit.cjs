...
try{
  execFileSync(process.execPath,['scripts/p2e-difficulty-calibration-repair.cjs'],{cwd:ROOT,env:{...process.env,P2E_INDEX:tmp},encoding:'utf8',stdio:['ignore','pipe','pipe'],maxBuffer:64*1024*1024});
