...
function fixture(run){
  ...
  try{
    const files=[id.MANIFEST,id.TRANSITION,id.BATCH03_MANIFEST,id.BATCH03_TRANSITION,id.BATCH04_MANIFEST,id.BATCH04_TRANSITION,id.P2A,...Object.keys(id.loadManifest().historicalEvidence)];
    ...
    id.currentP2ABaseline(root);id.loadTransition(root);id.loadBatch03Transition(root);id.loadBatch04Transition(root);
    run(root);
  }finally{
