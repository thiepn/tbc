...
function build() {
  evidence.successor = { prior: validateTransition(), batch03: validateBatch03Transition(), batch04: validateBatch04Transition() };
...
async function tests() {
  ...
  for (const script of ['p0a-preservation-audit', 'p0b-player-controls-audit',
    ...
    'tbc-question-revision-tests', 'tbc-four-question-quality', 'tbc-batch03-question-quality', 'tbc-batch04-question-quality',
